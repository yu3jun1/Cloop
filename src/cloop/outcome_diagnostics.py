...
Run with:
    ...
    python -m cloop.outcome_diagnostics \
...
from .artifacts import RunArtifacts, read_json, read_torch, write_json, write_torch
from .config import load_config
from .data import DataBundle, fit_preprocessing, load_bundle
from .metrics import mean_std, survival_summary
from .outcome import PiecewiseExponentialHead, event_bins, interval_exposure
...
def run_diagnostics(
    ...
    *,
    ...
    artifacts = RunArtifacts(config["paths"]["output_root"], str(diag["run"]))
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m cloop.outcome_diagnostics",
    ...
    parser.add_argument(
        "--diag-config",
        default="configs/outcome_diagnostics.yaml",
